...
%% Save results
save('results/ventricular_results.mat', 't', 'Yc', 'Vm', 'INa', 'ICaL', 'INaCa', 'If', 'IKr', 'IKs', 'IK1', 'Iup', 'Irel');

%% Verification Plot
figure;
plot(t, Vm*1e3, 'LineWidth', 1.2);
xlabel('Time (s)'); ylabel('Vm (mV)');
title('Ventricular-like hPSC-CM Action Potential (Paci2020)');
